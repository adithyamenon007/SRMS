...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #9370DB;">
	...
	<div class="container">
		<h3 style="text-align: center;">Student Entry Page</h3><br>
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-primary extra">
					...
					<div class="panel-body">
						<form method="post" action="entry_conf.php">
							...
							<div class="form-group">
								<label for="pm">Physics Marks:</label>
								<input type="text" name="pm" class="form-control">
							</div>
							<div class="form-group">
								<label for="cm">Chemistry Marks:</label>
								<input type="text" name="cm" class="form-control">
							</div>
							<div class="form-group">
								<label for="mm">Maths Marks:</label>
